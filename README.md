...
Visit the portfolio: **[philoshimm.github.io](https://philoshimm.github.io/)**
...
│
├── Lab2.html                  # HTML Fundamentals
├── Lab3/                      # CSS Styling & Layout
│   ├── Lab3.html
│   ├── lab3.css
│   └── PhotoOfPhilos.JPG
│
├── Lab5/                      # Multi-page Navigation
│   ├── Lab5.html
│   ├── about.html
│   ├── page1.html
│   ├── page2.html
...
│   └── PhotoOfPhilos.JPG
│
├── Lab6/                      # Responsive Design
│   ├── lab6.html
│   ├── lab6.css
│   ├── lab6.js
│   └── DSC01405.jpg
│
├── Lab8/                      # Media & Interactive Elements
│   ├── lab8.html
│   ├── lab8.css
│   ├── lab8.js
│   ├── DSC01405.jpg
...
│   ├── DSC09046.jpg
│   ├── SpadinaCNtower.jpg
│   └── Introducing Alpha 6700 _ Sony _ α.mp4
│
├── Lab10/                     # Advanced JavaScript & DOM
│   ├── Lab10.html
│   └── Lab10.css
│
└── Final Project/             # Capstone Portfolio Project
    ...
    │   ├── P icon.webp
    │   └── social media icons...
    └── bootstrap-4.0.0-dist/   # Bootstrap framework files
```
...
- **UX/UI**: Modern, intuitive user interface design
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/philoshimm/philoshimm.github.io.git
   cd philoshimm.github.io
   ```
...
3. **Access the portfolio**:
   ...
   - Navigate through different labs and projects
